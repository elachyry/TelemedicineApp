        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="patients.html" class="nav-item nav-link active"><i class="fa fa-user-plus me-2" aria-hidden="true"></i>Patients</a>
                                ...
                                <table class="table text-start align-middle table-bordered table-hover mb-0">
                                    ...
                                    <tbody>
                                        <tr class="text-center">
                                            <td name="nmPatient">Jhon Doe</td>
                                            <td name="sex">M</td>
                                            <td name="email">INV-0123</td>
                                            <td name="address">$123</td>
                                            <td name="birth">Paid</td>
                                            <td name="NumPhone">089775776</td>
                                        </tr>
                                        <tr class="text-center">
                                            <td>Jhon Doe</td>
                                            <td>M</td>
