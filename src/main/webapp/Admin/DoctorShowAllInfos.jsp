			...
			<div class="main-panel">
				<div class="content-wrapper">
					<div class="page-header">
						<h3 class="page-title">Doctor Informations</h3>
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="AllDoctors">Show
										All Doctors</a></li>
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="row">
										...
										<div class="col-lg-12">
										<center><img src="<%= rs.getString(2)%>" class="rounded-circle mx-auto d-block"  alt="doctor image"></center>	
										</div>
										...
										<div class="col-lg-6">
											<div class="card"
												...
												<div class="card-body">
													...
													<p >
													<center style="color: #1977cc;"><%=rs.getString(11)%></center>
													</p>
												</div>
											</div>
										</div>
										<div class="col-lg-6">
											<div class="card"
												...
												<div class="card-body">
													...
													<p >
													<center style="color: #1977cc;"><%=rs.getString(12)%></center>
													</p>
												</div>
											</div>
										</div>
