        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="messages.html" class="nav-item nav-link"><i class="fa fa-envelope me-2" aria-hidden="true"></i>Messages</a>
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                            <a href="#" class="dropdown-item">
                                <h6 class="fw-normal mb-0">Naima want to make an appointment</h6>
                                <!-- <small>15 minutes ago</small> -->
                            </a>
                            <hr class="dropdown-divider">
                            <a href="#" class="dropdown-item">
                                <h6 class="fw-normal mb-0">Peter want to make an appointment</h6>
                                <!-- <small>15 minutes ago</small> -->
                            </a>
                            <hr class="dropdown-divider">
                            <a href="#" class="dropdown-item">
                                <h6 class="fw-normal mb-0">Mohmmed want to make an appointment</h6>
                                <!-- <small>15 minutes ago</small> -->
                            </a>
                            <hr class="dropdown-divider">
                            <a href="#" class="dropdown-item text-center">See all demands</a>
                        </div>
                    </div>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="appointment.html">Show All</a>
                    </div>
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                <tr class="text-center">
                                    ...
                                    <td name="action"><a class="btn btn-sm btn-primary" href="" name="action" id="action">Pending</a></td>
                                </tr>
                                <tr class="text-center">
                                    <td>01 Jan 2045</td>
                                    <td>INV-0123</td>
