...
<body>
										...
										<div class="container">
											<div class="row">
												...
												<div class="col-lg-4 trash">
													<input type="text" name="search" id="search" onkeyup="searchText()"
	...
	<script>
		swal({
			...
			window.location.replace("/telemedicneApp/AllDoctors");
		});
	</script>
	<%
	...
	<script language="javascript">
		...
		function searchText() {
			...
			var url = "/telemedicneApp/DoctorSearch?search=" + search;
